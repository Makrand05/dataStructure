...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Enter 8 for add after..");
        System.out.println("Enter 9 for the delete element..");
        System.out.println("Enter 10 for the sort the linked list");
        switch (sc.nextInt())
        {
            case 1:
